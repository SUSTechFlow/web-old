<template>
  <Menu class="navbar" mode="horizontal" theme="dark" :active-name="activeItem">
    <div class="layout-logo">SUSTech Flow</div>
...
export default {
  ...
  watch: {
    $route(to) {
      ...
      if (to.name === "courseDetail") this.activeItem = "course";
    }
  }
};
</script>
